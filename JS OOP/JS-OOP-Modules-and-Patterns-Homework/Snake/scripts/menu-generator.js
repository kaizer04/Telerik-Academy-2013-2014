...
window.addEventListener("load", function load(event) {
    ...
    (function generateGameSettings() {
        ...
        //var sugestedPixels = 10;//10
        var suggestedObsticles = [300, 200, 100, 50, 40, 20, 15, 10, 1];//50
        var subbestedSpeed = [50, 50, 50, 75, 100, 120, 120, 135, 150];//150

        //for (var i = 0; i < sugestedPixels.length; i++) {
            var currSelection = document.createElement('option');
            currSelection.innerHTML = 10;
