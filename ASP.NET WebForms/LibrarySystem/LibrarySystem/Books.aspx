...
<asp:Content ID="ContentBody" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="search-button">
            <div class="form-search">
                <div class="input-append">
                    <asp:TextBox runat="server" id="TextBoxSearchParam" type="text" name="q" class="col-md-3 search-query"
    ...
    <asp:ListView runat="server" ID="ListViewCategories" ItemType="LibrarySystem.Models.Category" SelectMethod="ListViewCategories_GetData" GroupItemCount="3">
        ...
        <ItemTemplate>
            <div class="col-md-4">
                <h2><%#: Item.Name %></h2>
                <asp:Repeater runat="server" ID="RepeaterBooks" ItemType="LibrarySystem.Models.Book" DataSource="<%# Item.Books %>">
                    <HeaderTemplate>
                        <ul>
                            </HeaderTemplate>
                    <ItemTemplate>
    ...
    <%--<asp:Repeater runat="server" ID="RepeaterCategories" 
        ItemType="LibrarySystem.Models.Category" SelectMethod="RepeaterCategories_GetData">
        <ItemTemplate>
            <%#:Item.Name %>
        </ItemTemplate>
    </asp:Repeater>--%>
