...
class BonusScores
{
    ...
    {
        Console.Write("Applies bonus scores.\nPlease enter teh score in the range [1..9]: ");
        string score = Console.ReadLine();
        int newscore;
        bool val = int.TryParse(score, out newscore);
        if (val == true)
        {    
            switch (newscore)
            {
                ...
                case 2:
                case 3:
                    Console.WriteLine("The new score is {0}", newscore * 10);
                    break;
                case 4:
                case 5:
                case 6:
                    Console.WriteLine("The new score is {0}", newscore * 100);
                    break;
                case 7:
                case 8:
                case 9:
                    Console.WriteLine("The new score is {0}", newscore * 1000);
                    break;
                default:
                    Console.WriteLine("Error. Enter a correct score.");
                    break;
            }
        }
        else
