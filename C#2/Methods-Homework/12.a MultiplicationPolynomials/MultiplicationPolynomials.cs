...
class MultiplicationPolynomials
{
    ...
    static int[] MultiplicationTwoPolynomials(int[] array1, int[] array2)
    {
    ...
    static void Main()
    {
        ...
        PrintPolinomial(MultiplicationTwoPolynomials(polinomial1, polinomial2));
        Console.WriteLine();
    }
}